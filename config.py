...
MAX_WORKERS_TRANSLATE = 1000  # ThreadPool for translation (I/O bound)
MAX_WORKERS_TTS = 1000        # ThreadPool for TTS synthesis (I/O bound)
MAX_WORKERS_SCRAPER = 1000    # Concurrency for asynchronous scraping
