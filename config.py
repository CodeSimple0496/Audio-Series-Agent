...
MAX_WORKERS_TRANSLATE = 20  # ThreadPool for translation (I/O bound)
MAX_WORKERS_TTS = 20        # ThreadPool for TTS synthesis (I/O bound)
MAX_WORKERS_SCRAPER = 20    # Concurrency for asynchronous scraping
